...
<div class="w-full!" id="step_content">
    ...
    <input type="hidden" id="step8_formStartTime" name="step8_formStartTime">
        <script>document.getElementById('step8_formStartTime').value = Date.now();</script>
    <input type="text" name="step8_honeypot" id="step8_honeypot" style="display:none;">
