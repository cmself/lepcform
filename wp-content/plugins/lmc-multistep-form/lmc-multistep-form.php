   ...
   */
    ...
    $wpdb->query("
        CREATE TABLE IF NOT EXISTS $table_name (
          ...
          `step1_adherent` tinyint(1) NOT NULL DEFAULT '0',
          ...
          `step2_signataire_0` tinyint(1) NOT NULL DEFAULT '0',
          ...
          `step2_signataire_1` tinyint(1) NOT NULL DEFAULT '0',
          ...
          `step2_signataire_2` tinyint(1) NOT NULL DEFAULT '0',
          ...
          `step2_signataire_3` tinyint(1) NOT NULL DEFAULT '0',
          `step3_otp_hash` text NOT NULL,
          `step3_otp_expires` datetime NOT NULL,
          `step3_otp_used` tinyint(1) NOT NULL DEFAULT '0',
